...
Private Const Module_Name = "FormRoutines."
...
Public Function ValidateForm( _
    ...
    Const RoutineName = Module_Name & "ValidateForm"
    ...
    For I = 0 To Tbl.CellCount - 1
        ...
        TargetVal = Tbl.ActiveTarget.Value
...
Private Function ValString(ByVal Val As Variant) As String
    Const RoutineName = Module_Name & "ValString"
    On Error GoTo ErrorHandler
...
Private Function CheckRanges( _
    ...
    Const RoutineName = Module_Name & "CheckRanges"
    On Error GoTo ErrorHandler
...
Private Function ValidateWholeNumber( _
    ...
    Const RoutineName = Module_Name & "ValidateWholeNumber"
    On Error GoTo ErrorHandler
...
Private Function ValidateDecimal( _
    ...
    Const RoutineName = Module_Name & "ValidateDecimal"
    On Error GoTo ErrorHandler
...
Private Function ValidateList( _
    ...
    Const RoutineName = Module_Name & "ValidateList"
    On Error GoTo ErrorHandler
...
Private Function ValidateDate( _
    ...
    Const RoutineName = Module_Name & "ValidateDate"
    On Error GoTo ErrorHandler
...
Private Function ValidateTime( _
    ...
    Const RoutineName = Module_Name & "ValidateTime"
    On Error GoTo ErrorHandler
...
Private Function ValidateTextLength( _
    ...
    Const RoutineName = Module_Name & "ValidateTextLength"
    On Error GoTo ErrorHandler
    ...
    FormVal = Field.FormControl
    If Err.Number <> 0 Then MsgBox "Cell " & Field.HeaderText & " must be a string ", _
...
Private Function ValidateCustom( _
    ...
    Const RoutineName = Module_Name & "ValidateCustom"
    On Error GoTo ErrorHandler
...
Public Sub PopulateForm( _
    ...
    Const RoutineName = Module_Name & "PopulateForm"
    Debug.Assert InScope(ModuleList, ModuleName, RoutineName)
...
Public Sub ClearForm( _
    ...
    Const RoutineName = Module_Name & "ClearForm"
    Debug.Assert InScope(ModuleList, ModuleName, RoutineName)
    ...
    For I = 0 To Tbl.CellCount - 1
        ...
        Select Case Left(Field.FormControl.Name, 3)
        Case "lbl": ' Do nothing
        Case "val": Field.FormControl.Caption = ""
        Case "fld": Field.FormControl.Text = ""
        Case "cmb": Field.FormControl.Text = ""
        Case "whl": Field.FormControl.Text = ""
        Case "dat": Field.FormControl.Text = ""
        Case Else: Stop
        End Select
