...
Private Function SearchTable( _
    ...
    ByVal DataColumnName As String _
        ...
        KeyColumn = Application.WorksheetFunction.Match("Color Name", Tbl.HeaderRowRange, 0)
        On Error Resume Next
...
Public Function DarkestColorValue() As Long
    ...
    Else
        If ColorTableExistsOnWorksheet Then
            ...
            If DarkestColorValue = 0 Then DarkestColorValue = &H80000007
        Else
            DarkestColorValue = &H80000007
        End If
    End If
End Function
...
Public Function LightestColorValue() As Long
    ...
    Else
        If ColorTableExistsOnWorksheet Then
            ...
            If LightestColorValue = 0 Then LightestColorValue = &H8000000F
       Else
            LightestColorValue = &H8000000F
        End If
    End If
End Function
